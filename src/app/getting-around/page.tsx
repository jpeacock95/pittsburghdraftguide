      ...
      <section className="bg-primary-dark text-white py-12">
        <div className="max-w-3xl mx-auto px-4">
          <p className="text-sm text-gray-400 mb-2">
            <Link href="/" className="hover:text-white">Home</Link> / Getting Around
          </p>
          <h1 className="text-3xl md:text-4xl font-bold mb-3">
            Getting Around Pittsburgh During the Draft
          </h1>
          <p className="text-gray-300">
            The T light rail, Football Flyer shuttle buses, rideshare surge pricing tips, and
            walking routes between the main Draft venues and neighborhoods.
          </p>
        </div>
      </section>
