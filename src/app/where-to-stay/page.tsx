        ...
        <section className="mb-14">
          ...
          <div className="space-y-3 mb-4">
            <div className="card-minimal p-4">
              ...
              <p className="text-sm text-muted mb-1">530 William Penn Pl, Downtown  <a href="https://www.google.com/maps/dir/?api=1&destination=530+William+Penn+Pl+Pittsburgh+PA+15219" target="_blank" rel="noopener noreferrer" className="text-xs text-primary hover:underline py-2 px-3 rounded-md active:bg-primary/10 transition-colors inline-block">Get Directions</a></p>
            ...
            <div className="card-minimal p-4">
              ...
              <p className="text-sm text-muted mb-1">510 Market St, Downtown  <a href="https://www.google.com/maps/dir/?api=1&destination=510+Market+St+Pittsburgh+PA+15222" target="_blank" rel="noopener noreferrer" className="text-xs text-primary hover:underline py-2 px-3 rounded-md active:bg-primary/10 transition-colors inline-block">Get Directions</a></p>
              <p className="text-sm text-muted">
            ...
            <div className="card-minimal p-4">
              ...
              <p className="text-sm text-muted mb-1">745 Grant St, Downtown  <a href="https://www.google.com/maps/dir/?api=1&destination=745+Grant+St+Pittsburgh+PA+15219" target="_blank" rel="noopener noreferrer" className="text-xs text-primary hover:underline py-2 px-3 rounded-md active:bg-primary/10 transition-colors inline-block">Get Directions</a></p>
              <p className="text-sm text-muted">
        ...
        <section className="mb-14">
          ...
          <div className="space-y-3 mb-4">
            <div className="card-minimal p-4">
              ...
              <p className="text-sm text-muted mb-1">223 Federal St, North Shore  <a href="https://www.google.com/maps/dir/?api=1&destination=223+Federal+St+Pittsburgh+PA+15212" target="_blank" rel="noopener noreferrer" className="text-xs text-primary hover:underline py-2 px-3 rounded-md active:bg-primary/10 transition-colors inline-block">Get Directions</a></p>
              <p className="text-sm text-muted">
            ...
            <div className="card-minimal p-4">
              ...
              <p className="text-sm text-muted mb-1">260 North Shore Dr  <a href="https://www.google.com/maps/dir/?api=1&destination=260+North+Shore+Dr+Pittsburgh+PA+15212" target="_blank" rel="noopener noreferrer" className="text-xs text-primary hover:underline py-2 px-3 rounded-md active:bg-primary/10 transition-colors inline-block">Get Directions</a></p>
              <p className="text-sm text-muted">
            ...
            <div className="card-minimal p-4">
              ...
              <p className="text-sm text-muted mb-1">757 Casino Dr, North Shore  <a href="https://www.google.com/maps/dir/?api=1&destination=757+Casino+Dr+Pittsburgh+PA+15212" target="_blank" rel="noopener noreferrer" className="text-xs text-primary hover:underline py-2 px-3 rounded-md active:bg-primary/10 transition-colors inline-block">Get Directions</a></p>
              <p className="text-sm text-muted">
        ...
        <section className="mb-14">
          ...
          <div className="space-y-3 mb-4">
            ...
            <div className="card-minimal p-4">
              ...
              <p className="text-sm text-muted mb-1">Station Square, South Shore  <a href="https://www.google.com/maps/dir/?api=1&destination=300+W+Station+Square+Dr+Pittsburgh+PA+15219" target="_blank" rel="noopener noreferrer" className="text-xs text-primary hover:underline py-2 px-3 rounded-md active:bg-primary/10 transition-colors inline-block">Get Directions</a></p>
              <p className="text-sm text-muted">
        ...
        <section className="mb-14">
          ...
          <div className="space-y-3 mb-4">
            <div className="card-minimal p-4">
              ...
              <p className="text-sm text-muted mb-1">10015 Pendleton Way, Cranberry Township  <a href="https://www.google.com/maps/dir/?api=1&destination=10015+Pendleton+Way+Cranberry+Township+PA+16066" target="_blank" rel="noopener noreferrer" className="text-xs text-primary hover:underline py-2 px-3 rounded-md active:bg-primary/10 transition-colors inline-block">Get Directions</a></p>
              <p className="text-sm text-muted">
            ...
            <div className="card-minimal p-4">
              ...
              <p className="text-sm text-muted mb-1">Cranberry Township  <a href="https://www.google.com/maps/dir/?api=1&destination=Courtyard+by+Marriott+Cranberry+Woods+Pittsburgh+PA" target="_blank" rel="noopener noreferrer" className="text-xs text-primary hover:underline py-2 px-3 rounded-md active:bg-primary/10 transition-colors inline-block">Get Directions</a></p>
              <p className="text-sm text-muted">
